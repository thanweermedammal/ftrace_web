...
import 'package:ftrace_web/features/products/bloc/products_bloc.dart';
import 'package:ftrace_web/features/products/bloc/suppliers_bloc.dart';
import 'package:ftrace_web/features/products/data/categories_repository.dart';
import 'package:ftrace_web/features/products/data/products_repository.dart';
import 'package:ftrace_web/features/products/data/suppliers_repository.dart';
  ...
  Widget build(BuildContext context) {
    return MultiRepositoryProvider(
      providers: [
        ...
        RepositoryProvider(create: (_) => SuppliersRepository()),
      ],
      child: MultiBlocProvider(
        providers: [
          ...
          BlocProvider(
            create: (context) => HotelBloc(context.read<HotelRepository>()),
          ),
          BlocProvider(
          ...
          BlocProvider(
            create: (context) =>
                CategoriesBloc(context.read<CategoriesRepository>()),
          ),
          BlocProvider(
            create: (context) =>
                SuppliersBloc(context.read<SuppliersRepository>()),
          ),
        ],
        child: MaterialApp.router(
          debugShowCheckedModeBanner: false,
          title: 'FTrace Food Safety',
          theme: ThemeData(
